  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Perbarui Mahasiswa</h5>
      ...
      <div class="modal-body">
        <div class="form-group row">
          <label for="" class="col-sm-2 col-form-label">Nomor BP</label>
          <div class="col-sm-4">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="tempat" name="tempat" value="<?= $tmplahir ?>">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="date" class="form-control" id="tgl" name="tgl" value="<?= $tgllahir ?>">
          </div>
        </div>
        <div class="form-group row">
